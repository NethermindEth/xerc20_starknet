...
use xerc20_starknet::interfaces::ixerc20::IXERC20Dispatcher;
...
pub fn setup() -> Setup {
    ...
    Setup {
        ...
        user,
        minter,
        xerc20: IXERC20Dispatcher { contract_address: xerc20_address },
        token_name,
        token_symbol
    }
}
...
pub mod unit_mint_burn {
    ...
    use crate::unit::common::{bound, E40, U256MAX_DIV_2};
    use openzeppelin_token::erc20::interface::{ERC20ABIDispatcher, ERC20ABIDispatcherTrait};
...
pub mod unit_create_params {
    ...
    use crate::unit::common::{bound, E40, E18, U256MAX_DIV_2, HOUR, assert_approx_eq_rel};
    use openzeppelin_token::erc20::interface::{ERC20ABIDispatcher, ERC20ABIDispatcherTrait};
    use snforge_std::{
    ...
    #[test]
    fn testLimitVestsLinearly(mut limit: u256, mut minter_u128: u128) {
        let setup = setup();
    ...
    #[test]
    fn testOverflowLimitMakesItMax(mut limit: u256, mut minter_u128: u128, mut used_limit: u256) {
        let setup = setup();
